...
public class AddStudent  extends JFrame implements ActionListener{
    ...
    AddStudent(){
       ...
       labelRollno = new JLabel("1AK21CS"+first4);
       ...
       add(tfx);
        ...
        cbcourse.setBounds(120, 420, 120, 30);
    ...
    public void actionPerformed(ActionEvent ae){
            if(ae.getSource()==submit){
                ...
                String usn = labelRollno.getText();
                ...
                try{
                    ...
                    String query = "Insert into student value('"+name+"','"+fname+"','"+usn+"','"+dob+"','"+adress+"','"+phone+"','"+email+"','"+x+"','"+xii+"','"+adhar+"','"+course+"','"+branch+"')";
